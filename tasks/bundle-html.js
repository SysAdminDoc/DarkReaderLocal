...
const htmlEntries = [
    {
        title: 'DarkReaderLocal background',
    ...
    {
        title: 'DarkReaderLocal settings',
    ...
    {
        title: 'DarkReaderLocal developer tools',
    ...
    {
        title: 'DarkReaderLocal CSS editor',
